...
# Configurar la SDK oficial de Google Gemini
genai.configure(api_key=os.getenv("AIzaSyD760dKqyFOKmlFaNGITZqcXwbCSbOddSY"))
DATABASE_URL = os.getenv("postgresql://postgres:[YOUR-Ca$m26,Mq!x@DH5]@db.ixmusfmzvvniguziwmvi.supabase.co:5432/postgres")
